...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=12,20,24&height=220&section=header&text=twwch&fontSize=78&fontAlignY=36&desc=AI%20Full-Stack%20Engineer%20·%20Vibe%20Coding%20Practitioner&descAlignY=58&descSize=18&animation=twinkling" width="100%" />

<a href="https://github.com/twwch">
...
<p>
  ...
  <!-- TOTAL_STARS_BADGE_START --><img src="https://img.shields.io/badge/Total%20Stars-4.6k%2B-F59E0B?style=for-the-badge&labelColor=0D1117" /><!-- TOTAL_STARS_BADGE_END -->
...
- 🌱 <!-- STATS_LINE_START -->开源 **52** 仓库，累计 **4.6k+** stars<!-- STATS_LINE_END -->，代表作均已 Docker 一键部署
...
|---|---|---|
| [next-chat-skills](https://github.com/twwch/next-chat-skills) | Next.js AI 助手 · Skill 自主调用 · 黑盒执行脚本 | ⭐ 56 |
| [Mako](https://github.com/twwch/Mako) | 在线表情包制作与分享 Web 应用 | ⭐ 83 |
| [next-k8s-admin](https://github.com/twwch/next-k8s-admin) | 多集群 K8s 管理平台 · RBAC · 实时终端 | ⭐ 23 |
| [PDFVisualTranslator](https://github.com/twwch/PDFVisualTranslator) | Gemini 驱动的视觉感知 PDF 翻译，保留原始排版 | ⭐ 14 |
| [AI-Tracker](https://github.com/twwch/AI-Tracker) | LLM · Context Engineering · MCP 学习路径 | ⭐ 30 |
| [weflow](https://github.com/twwch/weflow) | 爬文 → AI 总结 → 配图 → 公众号发布全自动 | ⭐ 7 |
